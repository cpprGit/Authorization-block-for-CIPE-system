...
import ru.hse.cppr.security.ProjectRequestProfileSecurityProvider
...
class ProjectRequestProfileService(override val serviceName: String) : KoinComponent, ProfileService {
    ...
    private val securityProvider = ProjectRequestProfileSecurityProvider()


    override fun getProfile(id: UUID): Map<String, kotlin.Any?> {
        return formattedProjectRequestService.get(id)
    }
    ...
    override fun editProfile(id: UUID, body: Any, jwt: DecodedJWT) {
        ...
        formattedProjectRequestService.update(id, body)
    }
